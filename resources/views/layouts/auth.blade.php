                    ...
                    <div class="header-body text-center">
                        <div class="row justify-content-center">
                            <div class="col-xl-5 col-lg-6 col-md-8">
                                <img class="mb-5" src="{{ asset('public/img/logo_1.png') }}" width="35%" alt="Company Name"/>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row align-items-center justify-content-xl-between">
                        <div class="col-xl-12">
                            <div class="copyright text-center text-white">
                                {{-- <small>
                                    Powered By: Salon Software <a href="https://www.shivamits.com" target="_blank" class="text-white">Shivam ITS</a>
                                </small> --}}
                            </div>
                        </div>
                    </div>
